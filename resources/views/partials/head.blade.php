...
<link rel="icon" href="{!! url('/ocr_logo_mini_bg.png') !!}"/>
...
<link rel="stylesheet" href="{{url('libs/font-awesome-4.5.0/css/font-awesome.min.css')}}">
...
<link rel="stylesheet" href="{{ url('libs/DataTables/DataTables-1.10.16/css/jquery.dataTables.min.css') }}"/>
<link rel="stylesheet" href="{{ url('libs/DataTables/Select-1.2.5/css/select.dataTables.min.css') }}"/>

{{--  <link rel="stylesheet" href="//cdn.datatables.net/buttons/1.2.4/css/buttons.dataTables.min.css"/>  --}}
<link rel="stylesheet" href="{{ url('libs/DataTables/Buttons-1.5.1/css/buttons.dataTables.min.css') }}"/>
